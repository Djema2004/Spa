...
<head>
    ...
    <title>Administration - Spa Dream | Prestations</title>
...
<body class="text-[#4A2E30] flex">
    ...
    <main class="flex-1 p-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
            <div>
                <h2 class="text-3xl font-bold font-serif text-[#4A2E30]">Gestion des Prestations</h2>
                <p class="text-[#8E6E53] text-sm">Liste complète des soins et services du spa</p>
            </div>
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-6">
            <div class="relative flex-1">
                ...
                <input type="text" placeholder="Rechercher une prestation (nom, catégorie...)" class="w-full pl-12 pr-4 py-3 rounded-2xl border border-[#D2B48C]/30 bg-white/50 focus:outline-none focus:ring-2 focus:ring-[#D2B48C]">
            </div>
        ...
        <div class="bg-white/60 rounded-3xl border border-[#FCD7CC]/30 shadow-xl shadow-[#D2B48C]/5 overflow-hidden">
                ...
                <table class="w-full text-left text-sm">
                    <thead class="bg-[#D2B48C]/5 text-[#8E6E53] uppercase text-[10px] tracking-widest border-b border-[#FCD7CC]/50">
                        <tr>
                            ...
                            <th class="py-4 px-6">Nom Prestation</th>
                    ...
                    <tbody class="divide-y divide-[#FCD7CC]/30">
                        <tr class="text-[#4A2E30] hover:bg-[#D2B48C]/10 transition">
                            <td class="py-4 px-6 font-mono font-bold text-[#BA4A43]">#P001</td>
                            <td class="py-4 px-6 font-semibold">Massage Relaxant</td>
                            <td class="py-4 px-6">Massage</td>
                            <td class="py-4 px-6">60 min</td>
                            <td class="py-4 px-6 font-bold text-[#4A2E30]">3,500 HTG</td>
                            <td class="py-4 px-6 text-xs text-gray-600 max-w-xs truncate">Massage aux huiles essentielles pour détendre les muscles.</td>
                            <td class="py-4 px-6">
            ...
            <div class="p-4 bg-[#D2B48C]/5 text-center text-xs text-[#8E6E53] border-t border-[#FCD7CC]/30">
                Affichage de 1 à 1 sur 1 prestation totale
            </div>
        </div>
