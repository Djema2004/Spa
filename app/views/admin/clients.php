...
<head>
    ...
    <title>Administration - Spa Dream | Clients</title>
...
<body class="text-[#4A2E30] flex">
    ...
    <main class="flex-1 p-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
            <div>
                <h2 class="text-3xl font-bold font-serif text-[#4A2E30]">Gestion des Clients</h2>
                <p class="text-[#8E6E53] text-sm">Liste complète de vos clients enregistrés</p>
            </div>
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-6">
            <div class="relative flex-1">
                ...
                <input type="text" placeholder="Rechercher un client (nom, email, téléphone...)" class="w-full pl-12 pr-4 py-3 rounded-2xl border border-[#D2B48C]/30 bg-white/50 focus:outline-none focus:ring-2 focus:ring-[#D2B48C]">
            </div>
        ...
        <div class="bg-white/60 rounded-3xl border border-[#FCD7CC]/30 shadow-xl shadow-[#D2B48C]/5 overflow-hidden">
                ...
                <table class="w-full text-left text-sm">
                    ...
                    <tbody class="divide-y divide-[#FCD7CC]/30">
                        <tr class="text-[#4A2E30] hover:bg-[#D2B48C]/10 transition">
                            <td class="py-4 px-6 font-mono font-bold text-[#BA4A43]">#C001</td>
                            <td class="py-4 px-6 font-semibold">Jean</td>
                            <td class="py-4 px-6">Marie</td>
                            <td class="py-4 px-6">+509 3xxx-xxxx</td>
                            <td class="py-4 px-6 text-gray-600">marie@email.com</td>
                            <td class="py-4 px-6">Pétion-Ville</td>
                            <td class="py-4 px-6 text-xs text-[#8E6E53]">19/07/2026</td>
            ...
            <div class="p-4 bg-[#D2B48C]/5 text-center text-xs text-[#8E6E53] border-t border-[#FCD7CC]/30">
                Affichage de 1 à 1 sur 1 client total
            </div>
        </div>
