...
<head>
    ...
    <title>Administration - Spa Dream | Rendez-vous</title>
    ...
    <main class="flex-1 p-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
            <div>
                ...
                <p class="text-[#8E6E53] text-sm">Suivi des plannings, paiements et statuts des réservations</p>
            </div>
        ...
        <div class="flex flex-col md:flex-row gap-4 mb-6">
            <div class="relative flex-1">
                ...
                <input type="text" placeholder="Rechercher un rendez-vous (client, prestation, esthéticienne...)" class="w-full pl-12 pr-4 py-3 rounded-2xl border border-[#D2B48C]/30 bg-white/50 focus:outline-none focus:ring-2 focus:ring-[#D2B48C]">
            </div>
        ...
        <div class="bg-white/60 rounded-3xl border border-[#FCD7CC]/30 shadow-xl shadow-[#D2B48C]/5 overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm">
                    <thead class="bg-[#D2B48C]/5 text-[#8E6E53] uppercase text-[10px] tracking-widest border-b border-[#FCD7CC]/50">
                        <tr>
                            <th class="py-4 px-6">Rendez-vous</th>
                            <th class="py-4 px-6">Montant</th>
                            <th class="py-4 px-6">Mode de paiement</th>
                    ...
                    <tbody class="divide-y divide-[#FCD7CC]/30">
                        <tr class="text-[#4A2E30] hover:bg-[#D2B48C]/10 transition">
                            <td class="py-4 px-6">
                                <span class="font-bold block">Massage Relaxant</span>
                                <span class="text-xs text-[#8E6E53]">Client: Marie Jean (Esthéticienne: Sophie)</span>
                            </td>
                            <td class="py-4 px-6 font-semibold">3,500 HTG</td>
                            <td class="py-4 px-6">
                                <span class="bg-[#D2B48C]/20 text-[#4A2E30] px-3 py-1 rounded-full text-xs font-semibold">Carte bancaire</span>
                            </td>
                            <td class="py-4 px-6 text-xs text-[#8E6E53]">21/07/2026 à 14:00</td>
                            <td class="py-4 px-6">
                                <span class="text-green-600 font-bold bg-green-50 px-3 py-1 rounded-full text-xs">● Confirmé</span>
                            </td>
                            <td class="py-4 px-6 text-center">
                                <div class="flex justify-center gap-4">
                                    <button class="text-emerald-600 hover:scale-125 transition" title="Voir reçu"><i class="fas fa-receipt"></i></button>
            ...
            <div class="p-4 bg-[#D2B48C]/5 text-center text-xs text-[#8E6E53] border-t border-[#FCD7CC]/30">
                Affichage de 1 à 1 sur 1 rendez-vous total
            </div>
        </div>
